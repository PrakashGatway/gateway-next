'use client'; // This component uses hooks like useState, useEffect
...
export default function SingleBlogPage() {
  ...
  return (
    <>
      <Head>
        <title>{singleBlogData?.blogTitle || 'Blog Post'}</title>
        <meta name="description" content={singleBlogData?.descriptions || 'Read our latest blog posts.'} />
        <meta property="og:description" content={singleBlogData?.descriptions || 'Read our latest blog posts.'} />
        <meta name="keywords" content={singleBlogData?.keyword || ''} />
        <meta property="og:keywords" content={singleBlogData?.keyword || ''} />
        {singleBlogData?.seoImage && (
          <>
            <meta name="image" content={`${constant.REACT_APP_URL}/uploads/${singleBlogData?.seoImage}`} />
            <meta property="og:image" content={`${constant.REACT_APP_URL}/uploads/${singleBlogData?.seoImage}`} />
          </>
        )}
        <meta name="title" content={singleBlogData?.blogTitle || 'Blog Post'} />
        <meta property="og:title" content={singleBlogData?.blogTitle || 'Blog Post'} />
        <meta name="robots" content={singleBlogData?.robotContent || 'index, follow'} />
      </Head>
